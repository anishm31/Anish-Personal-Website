...
const Navbar = () => {
  ...
  return (
    /* mobile view supported too (navbar toggle in and out, opens as sidebar on smaller screens)*/
    <div>
      <div className='bg-black text-gray-400 h-[100px] max-w-[1200px] mx-auto flex justify-between items-center'>

        <h1 className='text-3xl font-bold primary-color ml-4'>Anish Madgula</h1>
        ...
        <div className={nav ? 'z-10 fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500' : 'fixed left-[-100%]'}>
          <h1 className='text-3xl primary-color m-4'>Anish Madgula</h1>
          <ul>
